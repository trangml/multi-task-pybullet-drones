...
New environments can be found in the [env] (https://github.com/trangml/multi-task-pybullet-drones/gym-pybullet-drones/envs) directory.
These use configurations of the reward and terminations that can be found in [rewards] (https://github.com/trangml/multi-task-pybullet-drones/gym-pybullet-drones/envs)
