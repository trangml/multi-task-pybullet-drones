...
from gym_pybullet_drones.envs.single_agent_rl.obstacles.FurnitureRoom import (
    FurnitureRoom,
)
...
class RoomAviary(BaseSingleAgentAviary):
    """Single agent RL problem: a room with realistic furniture obstacles"""
    ...
    def __init__(
        ...
        # Add the default reward component
        if len(self.reward_components) == 0:
            self.reward_components.append(NoCollisionReward(scale=1.0))
        ...
        # if we haven't added a collision term, add defaults
