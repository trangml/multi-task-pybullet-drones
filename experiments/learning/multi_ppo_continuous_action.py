...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="multi-cross-obs-aviary-v0",
        help="the id of the environment")
    parser.add_argument("--env-config", type=str, default="config/multicross-obstacles-aviary.yaml",
                ...
                if "episode" in item.keys():
                    ...
                    if item["episode"]["r"] > best_model_reward:
                        ...
                        with open(f"results/{run_name}/best_reward.txt", "w") as f:
                            f.write(
                                f"timestep {global_step}: reward {best_model_reward} \n"
                            )
                    break
