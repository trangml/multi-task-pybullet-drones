...
def sample_drone_params(trial: optuna.Trial) -> Dict[str, Any]:
    distance_scale = trial.suggest_categorical("DistanceReward.scale", [0,1,2,3,4,5,10])
    deltadist_scale = trial.suggest_categorical("DeltaDistanceReward.scale", [0,1,2,3,4,5,10])
    slowdown_scale = trial.suggest_categorical("SlowdownReward.scale", [0,1,2,3,4,5,10])
    speed_scale = trial.suggest_categorical("SpeedReward.scale", [0,1,2,3,4,5,10])
    bounds_scale = trial.suggest_categorical("BoundsReward.scale", [0,1,2,3,4,5,10])
